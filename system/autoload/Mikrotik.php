...
public static function addStaticUser($client, $plan, $customer,)
{
    ...
    $rateLimit = $plan['rate_limit']; // Assuming 'rate_limit' is the correct field name
    $addQueueRequest = new RouterOS\Request('/queue/simple/add');
    $client->sendSync(
        $addQueueRequest
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////public static function removeStaticUser($client, $customer) {
    public static function removeStaticUser($client, $username) {
        ...
        $pdo = new PDO('mysql:host=localhost;dbname=test', 'root', 'Magomere@1996');
    
        // Prepare a SQL statement to fetch the customer data
        $stmt = $pdo->prepare('SELECT * FROM tbl_customers WHERE username = :username');
        ...
        if (!$customer) {
            ...
            error_log("Customer with username $username not found");
            return;
        }
        ...
        try {
            ...
            $findQueueRequest->setQuery(Query::where('name', 'Queue-' . $customer->username));
