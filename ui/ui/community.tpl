            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    <a href="https://FreeIspRadius.com" target="_blank"
                        ...
                        Discussions</a>
                    <a href="https://t.me/eldonet" target="_blank" class="btn btn-primary btn-sm btn-block"><i
        ...
        <div class="box box-primary box-hovered mb20 activities">
            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    ...
                    <a href="https://github.com/gomez1996/phpnuxbill/archive/refs/heads/master.zip" target="_blank"
            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    <a href="./CHANGELOG.md" target="_blank" class="btn btn-default btn-sm btn-block">Current
                        Changelog</a>
                    <a href="https://github.com/gomez1996/phpnuxbill/blob/master/CHANGELOG.md" target="_blank"
...
<script>
    window.addEventListener('DOMContentLoaded', function() {
        ...
        $.getJSON("https://raw.githubusercontent.com/gomez1996/phpnuxbill/master/version.json?" + Math
            .random(),
            function(data) {
