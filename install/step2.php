    ...
    <div id='main-container'>
        ...
        <div class="span12">
            ...
            if (version_compare(PHP_VERSION, '7.2.0') >= 0) {
                $ltext .= 'To Run FreeIspRadius  You need at least PHP version 7.2.0, Your PHP Version is: ' . PHP_VERSION . " Tested <strong>---PASSED---</strong><br/>";
                $passed .= '1';
            } else {
                $ltext .= 'To Run FreeIspRadius  You need at least PHP version 7.2.0, Your PHP Version is: ' . PHP_VERSION . " Tested <strong>---FAILED---</strong><br/>";
                $passed .= '0';
            }
            ...
            if ($passed == '111') {
                echo ("<br/> $ltext <br/> Great! System Test Completed. You can run FreeIspradius on your server. Click Continue For Next Step.
				<br><br>
				<a href=\"step3.php\" class=\"btn btn-primary\">Continue</a><br><br><a href=\"update.php\" class=\"btn btn-primary\">Update System</a>");
            } else {
                echo ("<br/> $ltext <br/> Sorry. The requirements of FreeIspRadius  is not available on your server.
				Contact with us at Telegram <a href=\"https://t.me/eldonet\">@FreeIspRadius</a> with this code- $passed Or contact with your server administrator
				<br><br>
