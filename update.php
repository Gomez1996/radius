...
<head>
    ...
    <title>FreeIspRadius Updater</title>
...
<body class="hold-transition skin-blue">
    <div class="container">
                    ...
                    <?php if ($continue || $step == 5) { ?>
                        ...
                        <?php } else if ($step == 5) { ?>
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    FreeIspRadius has been updated to Version <b><?= $version ?></b>
                                </div>
                            </div>
        ...
        <footer class="footer text-center">
            FreeIspRadius by <a href="https://freeispradius.com" rel="nofollow noreferrer noopener" target="_blank">FreeIspRadius</a>
        </footer>
    </div>
</body>
